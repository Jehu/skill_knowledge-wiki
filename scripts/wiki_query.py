...
def generate_answer(question: str, context_files: List[dict]) -> Tuple[str, int, str, float]:
    ...
    prompt = (
        ...
        "- Nutze ausschließlich die bereitgestellten Wiki-Einträge als Primärbasis.\n"
        "- Füge kein externes Fachwissen, keine allgemeinen Frameworks und keine Best Practices hinzu, außer du markierst den Absatz ausdrücklich als inferiert.\n"
        "- Jede konkrete, nicht-triviale Behauptung soll eine Quellenangabe haben.\n"
        "- Wenn du mehrere Quellen synthetisierst, nenne die wichtigsten Quellen im jeweiligen Absatz.\n"
